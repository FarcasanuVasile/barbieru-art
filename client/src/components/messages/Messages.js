...
const Messages = () =>{
    ...
    return (
        <div className="row">
            ...
            {filtered !== null ? filtered.map(message => (<MessageItem key={message._id} message={message} />) )  : messages !== null && messages.map(message =>  (<MessageItem key={message._id} message={message} />) )}
